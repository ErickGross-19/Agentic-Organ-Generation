...
interface ScaffoldTypeEntry {
  value: ScaffoldType;
  label: string;
  description: string;
}

interface ScaffoldCategory {
  label: string;
...
const SCAFFOLD_CATEGORIES: ScaffoldCategory[] = [
  ...
  {
    label: 'Vascular Backends (AOG)',
    types: [
      { value: ScaffoldType.SPACE_COLONIZATION, label: 'Space Colonization', description: 'Organic vascular growth algorithm' },
      { value: ScaffoldType.BIFURCATING_TREE, label: 'Bifurcating Tree', description: 'Regular geometric branching tree' },
    ],
  },
];
